...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '16826665967@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"sellerJid": "16826665967@s.whatsapp.net",
...
const botzkayla = "16826665967@s.whatsapp.net"
...
owned = '16826665967@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 16826665967`)
...
"url": `https://wa.me/16826665967`
},
"businessOwnerJid": "16826665967@s.whatsapp.net",
}
...
let e = String(err)
sendKaylaMessage("16826665967@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
